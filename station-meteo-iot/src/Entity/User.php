...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: WeatherStation::class, mappedBy: 'user', orphanRemoval: true)]
    private Collection $weatherStations;
    ...
    {
        if ($this->weatherStations->removeElement($weatherStation)) {
            // set the owning side to null (unless already changed)
            if ($weatherStation->getUser() === $this) {
                $weatherStation->setUser(null);
            }
        }
